...
<body class="bg-cleanLight text-xl">
    <section>
        <div class="flex items-center justify-center w-full my-6">
            <form id="myForm" action="#" method="post" class="mt-8 w-[550px] text-lessDark px-8 pb-12 bg-light rounded-xl shadow-xl">
                <h1 class="text-3xl text-center py-5">Register here !</h1>
                <div class="space-y-5">
                    <div>
                        <label for="" class="font-medium"> Full Name </label><br><span id="fnameError" class="text-lightRed"></span>
                        <div class="mt-2.5">
                            <input type="text" name="fullname" id="fullname" placeholder="Enter your full name" class="block w-full p-4 rounded outline-0 bg-ivory text-lessDark" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2.5">
                            <input type="email" name="email" id="email" placeholder="Enter email to get started" class="block w-full p-4 rounded outline-0 bg-ivory text-lessDark" />
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="mt-2.5">
                            <input type="text" name="phone" id="phone" placeholder="Phone number" class="block w-full p-4 rounded outline-0 bg-ivory text-lessDark" />
                        </div>
                    </div>

                    <div>
                        <label for="" class="font-medium"> Password </label><br><span id="password1Error" class="text-lightRed"></span>
                        <div class="mt-2.5">
                            <input type="password" name="password" id="password" placeholder="Enter your password" class="block w-full p-4 rounded outline-0 bg-ivory text-lessDark" />
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="mt-2.5">
                            <input type="password" name="cpassword" id="cpassword" placeholder="Enter your password" class="block w-full p-4  rounded outline-0 bg-ivory text-lessDark" />
                        </div>
                    </div>
                    <div>
                        <button type="submit" name="submit" class="w-full py-4 text-dark rounded" style="background-color: black;">
                            Create account
                        </button>
                    </div>
