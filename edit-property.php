...
if (isset($_POST['update'])) {
    ...
    $property_city = trim($_POST['city']);
    $property_title = trim($_POST['title']);
    $property_about = trim($_POST['about']);
    $property_listing_type = $_POST['listing_type'];
    $property_price = trim($_POST['price']);
    $property_iframe = trim($_POST['iframe']);
